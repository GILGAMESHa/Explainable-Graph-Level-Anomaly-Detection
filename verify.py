...
def arg_parse():
    ...
    parser.add_argument('--ds_name', default='AIDS', help='dataset name')
...
def main(psi1, psi2, h, adj_list, x_list, class_labels):
    ...
    sim_graphs = find_most_similar_normal_samples_with_neighbors(idk_map, scores, anomaly_ratio=0.005)
...
if __name__ == '__main__':
    ...
    visualize_anomaly_with_neighbors2(sim_graphs, adj_list, class_labels, scores,max_rows=5, seed=2021)
